    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-4xl grid md:grid-cols-2 bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="hidden md:flex flex-col justify-center px-10 py-12 bg-gradient-to-br from-indigo-600 to-indigo-400 text-white gap-6">
          <h2 className="text-3xl font-extrabold">Teach or learn with confidence</h2>
          <p className="opacity-90">Create your account and start building or teaching courses with ease.</p>

          <ul className="space-y-2">
            <li className="flex items-start gap-2"><span className="mt-1 text-indigo-200">●</span> <span className="text-sm opacity-90">Create courses</span></li>
            <li className="flex items-start gap-2"><span className="mt-1 text-indigo-200">●</span> <span className="text-sm opacity-90">Engage students</span></li>
            <li className="flex items-start gap-2"><span className="mt-1 text-indigo-200">●</span> <span className="text-sm opacity-90">Grow your audience</span></li>
          </ul>

          <div className="mt-4">
            <Link to="/login" className="inline-block px-4 py-2 bg-white text-indigo-600 rounded-md font-medium hover:bg-indigo-50">Have an account? Sign in</Link>
          </div>
        </div>
        ...
        <div className="px-8 py-10">
          ...
          <p className="mt-2 text-sm text-gray-600">Sign up to start learning or teaching on EduPlatform</p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4" autoComplete="off">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <select
                  ...
                  className="appearance-none w-full px-4 py-3 pr-10 border border-gray-200 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-indigo-400"
                  aria-label="Role"
                >
            ...
            <p className="text-sm text-gray-500">Already have an account? <Link to="/login" className="text-indigo-600 hover:underline">Sign in</Link></p>
          </form>
        </div>
      </div>
    </div>
